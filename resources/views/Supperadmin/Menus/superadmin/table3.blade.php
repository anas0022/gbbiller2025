...
@push('modals')
    ...
    <div class="modal" tabindex="-1" role="dialog" id="deleteConfirmModal3" data-bs-backdrop="static" data-bs-keyboard="false">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" id="deleteConfirmModal3" onclick="deleteModule3()">Delete</button>
      </div>
    </div>
        </div>
    </div> 
