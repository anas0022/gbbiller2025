...
@push('modals')
                    ...
                    <form id="addColumnsForm">
                        ...
                        <div id="columnsContainer">
                            <div class="form-row mb-2 columnRow border p-2 rounded">
                                ...
                                <div class="col">
                                    <input type="number" name="columns[0][length]" placeholder="Length (e.g. 255)"
                                        class="form-control">
                                </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="updateTableColumn" data-bs-backdrop="static"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="updateTableForm">
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            <button type="button" id="addUpdateColumnBtn" class="btn btn-secondary btn-sm">Add Another
                                Column</button>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="deleteTableColumn" data-bs-backdrop="static"
        data-bs-keyboard="false">
                ...
                <div class="modal-body">
                    <form id="deleteTableForm">
                        ...
                        <div id="deleteColumnsInfo" class="alert alert-warning" style="display: none;">
                            <strong>⚠️ Warning:</strong> This action will permanently delete the selected columns and all
                            their data!
                        </div>

                        <div id="deleteColumnsContainer" style="display: none;">
                            <label class="form-label">Select Columns to Delete:</label>
                            <div id="columnsCheckboxes" class="border p-3 rounded"
                        ...
                        <div class="d-flex justify-content-between mt-3">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm" id="deleteColumnsBtn" disabled>Delete
